...
'''
from Modules.MetaRNNs import MetaLSTM
...
if use_gpu and torch.cuda.is_available():
    gpu = True
meta_model = meta_LSTMModel(input_size, hidden_size, hyper_hidden_size, hyper_embedding_size, num_layers, num_classes, bias=True)
if gpu:
...
train(meta_model, 'meta_LSTM', '../models/meta_LSTM.pkl')
