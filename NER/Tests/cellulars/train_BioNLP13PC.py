...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../models/multiDatasets/cellulars/BioNLP13PC') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../models/multiDatasets/cellulars/BioNLP13PC.dset') # catnlp
    parser.add_argument('--train', default='../../../data/cellular/BioNLP13PC-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../data/cellular/BioNLP13PC-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../data/cellular/BioNLP13PC-IOBES/test.tsv') # catnlp
