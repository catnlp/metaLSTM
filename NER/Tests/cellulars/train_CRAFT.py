...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../models/multiDatasets/cellulars/CRAFT') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../models/multiDatasets/cellulars/CRAFT.dset') # catnlp
    parser.add_argument('--train', default='../../../data/cellular/CRAFT-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../data/cellular/CRAFT-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../data/cellular/CRAFT-IOBES/test.tsv') # catnlp
