...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../models/multiDatasets/cellulars/jointCellulars') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../models/multiDatasets/cellulars/jointCellulars.dset') # catnlp
    parser.add_argument('--train', default='../../../data/cellular/jointCellulars/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../data/cellular/jointCellulars/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../data/cellular/jointCellulars/test.tsv') # catnlp
    ...
    if status == 'train':
        ...
        name = 'jointCellulars' # catnlp
        ignore = True
        train(config, name, dset_dir, save_model_dir, seg, ignore)
    elif status == 'test':
