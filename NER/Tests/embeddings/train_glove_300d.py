...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../models/multiEmbeddings/glove300d') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../models/multiEmbeddings/glove300d.dset') # catnlp
