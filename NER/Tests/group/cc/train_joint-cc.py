...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/cc/joint-cc') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/cc/joint-cc.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/cc/joint-cc/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/cc/joint-cc/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/cc/joint-cc/test.tsv') # catnlp
