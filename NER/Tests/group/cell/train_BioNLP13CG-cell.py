...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/cell/BioNLP13CG-cell') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/cell/BioNLP13CG-cell.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/cell/BioNLP13CG-cell-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/cell/BioNLP13CG-cell-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/cell/BioNLP13CG-cell-IOBES/test.tsv') # catnlp
