...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/chem/BC4CHEMD') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/chem/BC4CHEMD.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/chem/BC4CHEMD-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/chem/BC4CHEMD-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/chem/BC4CHEMD-IOBES/test.tsv') # catnlp
