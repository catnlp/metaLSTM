...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/chem/BC5CDR-chem') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/chem/BC5CDR-chem.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/chem/BC5CDR-chem-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/chem/BC5CDR-chem-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/chem/BC5CDR-chem-IOBES/test.tsv') # catnlp
