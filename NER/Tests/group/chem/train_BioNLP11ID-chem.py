...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/chem/BioNLP11ID-chem') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/chem/BioNLP11ID-chem.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/chem/BioNLP11ID-chem-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/chem/BioNLP11ID-chem-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/chem/BioNLP11ID-chem-IOBES/test.tsv') # catnlp
