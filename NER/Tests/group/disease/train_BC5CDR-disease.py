...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/disease/BC5CDR-disease') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/disease/BC5CDR-disease.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/disease/BC5CDR-disease-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/disease/BC5CDR-disease-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/disease/BC5CDR-disease-IOBES/test.tsv') # catnlp
