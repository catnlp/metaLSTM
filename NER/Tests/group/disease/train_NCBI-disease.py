...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/disease/NCBI-disease') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/disease/NCBI-disease.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/disease/NCBI-disease-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/disease/NCBI-disease-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/disease/NCBI-disease-IOBES/test.tsv') # catnlp
