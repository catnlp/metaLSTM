...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/disease/joint-disease') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/disease/joint-disease.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/disease/joint-disease/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/disease/joint-disease/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/disease/joint-disease/test.tsv') # catnlp
