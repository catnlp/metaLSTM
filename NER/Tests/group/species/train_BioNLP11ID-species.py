...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/species/BioNLP11ID-species') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/species/BioNLP11ID-species.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/species/BioNLP11ID-species-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/species/BioNLP11ID-species-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/species/BioNLP11ID-species-IOBES/test.tsv') # catnlp
    ...
    if status == 'train':
        ...
        name = 'BioNLP11ID-species' # catnlp
