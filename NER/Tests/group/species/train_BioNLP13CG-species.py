...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/species/BioNLP13CG-species') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/species/BioNLP13CG-species.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/species/BioNLP13CG-species-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/species/BioNLP13CG-species-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/species/BioNLP13CG-species-IOBES/test.tsv') # catnlp
    ...
    if status == 'train':
        ...
        name = 'BioNLP13CG-species' # catnlp
