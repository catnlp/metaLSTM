...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/species/CRAFT-species') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/species/CRAFT-species.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/species/CRAFT-species-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/species/CRAFT-species-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/species/CRAFT-species-IOBES/test.tsv') # catnlp
