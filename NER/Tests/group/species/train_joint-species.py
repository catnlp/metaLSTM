...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/species/joint-species') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/species/joint-species.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/species/joint-species/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/species/joint-species/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/species/joint-species/test.tsv') # catnlp
