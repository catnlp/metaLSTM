...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../../../../models/multiDatasets/group/species/linnaeus') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../../../../models/multiDatasets/group/species/linnaeus.dset') # catnlp
    parser.add_argument('--train', default='../../../../data/group/species/linnaeus-IOBES/train.tsv') # catnlp
    parser.add_argument('--dev', default='../../../../data/group/species/linnaeus-IOBES/devel.tsv') # catnlp
    parser.add_argument('--test', default='../../../../data/group/species/linnaeus-IOBES/test.tsv') # catnlp
