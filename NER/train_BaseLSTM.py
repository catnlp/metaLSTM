...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='../models/conll2003/BaseLSTM') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='../models/conll2003/BaseLSTM.dset') # catnlp
